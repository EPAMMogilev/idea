...
public class CommentController {
	...
	public HttpEntity<CommentResource> show(@PathVariable final long commentId) {
		...
		return new ResponseEntity<>(new CommentResourceAsm().toModel(foundComment), HttpStatus.OK);
	}
	...
	public HttpEntity<CommentResource> changeLike(@PathVariable final long commentId) {
		...
		return new ResponseEntity<>(new CommentResourceAsm().toModel(updatedComment), HttpStatus.OK);
	}
}
