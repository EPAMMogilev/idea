...
insert into IDEA (TITLE, DESCRIPTION, CREATION_TIME, MODIFICATION_TIME, RATING, USER_ID, LATITUDE, LONGITUDE, STATE) values ('Parking for bicycles', 'It is very anticipated', '2015-05-13', '2015-05-13', 8, 4, 53.903200, 30.335055, 'Deleted');
insert into IDEA (TITLE, DESCRIPTION, CREATION_TIME, MODIFICATION_TIME, RATING, USER_ID, LATITUDE, LONGITUDE, STATE) values ('Areas for walking of dogs', ' Nice to have', '2015-01-26', '2015-01-26', 2, 3, 53.911445, 30.328036, 'New');
insert into IDEA (TITLE, DESCRIPTION, CREATION_TIME, MODIFICATION_TIME, RATING, USER_ID, LATITUDE, LONGITUDE, STATE) values ('Video surveillance for the zoo', 'It could be really interesting', '2015-03-30', '2015-03-30', 12, 2, 53.860442, 30.258000, 'New');
insert into IDEA (TITLE, DESCRIPTION, CREATION_TIME, MODIFICATION_TIME, RATING, USER_ID, LATITUDE, LONGITUDE, STATE) values ('Free Wi-Fi', 'Mogilev needs zones with free wi-fi', '2015-06-02', '2015-06-02', 23, 2, 53.894325, 30.330429, 'New');
insert into IDEA (TITLE, DESCRIPTION, CREATION_TIME, MODIFICATION_TIME, RATING, USER_ID, LATITUDE, LONGITUDE, STATE) values ('Pushkin Bridge repairment', 'The bridge needs full reconstruction', '2015-04-05', '2015-04-05', 31, 4, 53.892096, 30.329662, 'New');
insert into IDEA (TITLE, DESCRIPTION, CREATION_TIME, MODIFICATION_TIME, RATING, USER_ID, LATITUDE, LONGITUDE, STATE) values ('Mogilev Half Marathon', 'For amateurs and professionals', '2015-04-16', '2015-04-16', 19, 2, 53.895185, 30.330892, 'New');
insert into IDEA (TITLE, DESCRIPTION, CREATION_TIME, MODIFICATION_TIME, RATING, USER_ID, LATITUDE, LONGITUDE, STATE) values ('Cafe with cats', 'Good place for rest', '2014-12-21', '2015-12-21', 0, 3, 53.895815, 30.333220, 'Draft');
