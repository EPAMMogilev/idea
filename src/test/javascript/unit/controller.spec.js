...
describe('Idea controllers testing', function () {
    ...
    beforeEach(inject(function ($state, $rootScope, $controller) {
        ...
        //init getMapCenterInvoke
        getMapCenterInvoke = function () {
            return "";
        };

        //init getMapDefaultZoomInvoke
        getMapDefaultZoomInvoke = function () {
            return "";
        };

        myMapGeoService = {
            getMapCenter: getMapCenterInvoke,
            getMapDefaultZoom: getMapDefaultZoomInvoke
        };
