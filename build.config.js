...
module.exports = {
  ...
  build_dir: 'build',
  compile_dir: 'bin',
  resource_dir: "src/main/webapp/static",
  ...
  app_files: {
    ...
    //externaljs: [ 'node_modules/@bower_components/**/*.js'],
    jslong: [ 'src/main/webapp/static/js/**/*.js', '!src/main/webapp/static/js/**/*.spec.js'],
    jsunit: [ 'js/**/*.spec.js' ],
    json: ['languages/*.json'],
    html: [ 'index.html' ],
